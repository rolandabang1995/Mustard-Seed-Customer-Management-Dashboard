...
Public Class CrystalReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mustard_Seed_Customer_Management_Dashboard.CrystalReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Agent_Name() As CrystalDecisions.[Shared].IParameterField
        Get
